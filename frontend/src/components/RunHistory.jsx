...
import { clearRuns, deleteRun, fetchRun, fetchRuns } from "../api/client.js";
...
export default function RunHistory({ onSelect, refreshKey }) {
  ...
  const openRun = async (id) => {
    try {
      ...
      onSelect?.({
        ...
        oos_metrics: meta.oos_metrics || null,
        ...
        fill_timing: row.params?.fill_timing ?? meta.costs?.fill_timing,
        allow_short: row.params?.allow_short ?? meta.costs?.allow_short,
  ...
  const onDelete = async (e, id) => {
    ...
    try {
      ...
      setError(err?.message || "could not delete run");
    }
  };
