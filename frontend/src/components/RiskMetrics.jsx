// metric tiles - numbers ease in on mount
...
export default function RiskMetrics({
  ...
  const cards = [
    ...
    },
    {
      ...
      tip: "percent of days the sim held a position (long or short)",
    ...
    {
      label: "trades",
      tip: "how many round trips closed",
      display: String(Math.max(0, Math.round(animTrades))),
      tone: "neutral",
    },
    {
      label: "total costs",
      tip: "sum of commission fees charged - slippage is in the fills not this line",
