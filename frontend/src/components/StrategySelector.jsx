  ...
  return (
    <form className="strategy-panel" onSubmit={handleSubmit}>
      ...
      <div className="field-row">
        <label className="field">
          <TipLabel tip="first day of the price history for this run">start</TipLabel>
          <input type="date" value={start} onChange={(e) => setStart(e.target.value)} required />
        </label>
        <label className="field">
          <TipLabel tip="last day of the price history for this run">end</TipLabel>
      ...
      {showRsi && (
        <div className="slider-block">
          ...
          <label className="slider-label">
            <TipLabel tip="rsi above this = sell signal">overbought ({overbought})</TipLabel>
            <input
              type="range"
              min={55}
              max={95}
          ...
          <label className="slider-label">
            <TipLabel tip="rsi below this = buy signal">oversold ({oversold})</TipLabel>
            <input
              type="range"
              min={5}
              max={45}
      ...
      {showMl && (
        <div className="slider-block">
          <label className="check-label">
            ...
            />
            <TipLabel tip="trains then tests on later chunks so the model doesnt see future bars">
      ...
      <div className="slider-block">
        ...
        <label className="slider-label">
          <TipLabel tip="slippage worsens the fill - buys cost more, sells get less">
        ...
        <label className="slider-label">
          <TipLabel tip="if equity drops this % from its peak the sim flattens and stops buying">
